...
namespace BlogProject_5175.WEB.Areas.Member.Controllers
{
    ...
    public class AppUserController : Controller
    {
        ...
        public async Task<IActionResult> DeleteUser(AppUser appuser)
        {
            AppUser deleted = appUserRepository.GetDefault(a => a.ID == appuser.ID);
            appUserRepository.Delete(deleted);
