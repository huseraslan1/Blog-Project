    ...
    public partial class one : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FollowedCategories", x => new { x.AppUserID, x.CategoryID });
                    table.ForeignKey(
                        name: "FK_FollowedCategories_AppUsers_AppUserID",
                        column: x => x.AppUserID,
                        principalTable: "AppUsers",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Likes", x => new { x.ArticleID, x.AppUserID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FollowedCategories_CategoryID",
                table: "FollowedCategories",
                column: "CategoryID");
